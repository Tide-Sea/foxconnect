...
const ChannelFacebookForm = (props) => {
      ...
      <div className="relative flex flex-col flex-auto items-center px-24 sm:px-48 mt-48">
        <div className="w-full max-w-3xl">
          <Typography className="w-full font-bold truncate" variant="h5">
            {facebookUser ? 'Editing Facebook channel' : 'Connecting FB Messenger'}
          </Typography>

          <Divider className="mt-16 mb-24" />
        </div>
        {facebookUser ? (
          <div className="flex flex-col w-full space-y-20 mt-12">
            <Typography variant="body2">
              Click Login with Facebook. Sign in may be requested
            </Typography>
            <div className="flex sm:flex-row flex-col justify-between sm:space-y-0 space-y-16">
              ...
              <div className="flex sm:flex-col flex-row sm:space-y-8 space-x-8 items-end justify-center">
                <FacebookLogin
                  appId={facebookAppId}
                  ...
                  render={(renderProps) => (
                    ...
                    <Button variant="contained" color="secondary" onClick={renderProps.onClick}>
                      <FuseSvgIcon size={20}>material-solid:settings</FuseSvgIcon>
                      <span className="mx-8">Setting</span>
                    </Button>
                  )}
                />
            ...
            <Alert className="my-16 " variant="outlined" severity="info">
              {`Click "Add" to connect a Facebook Page from the List.`}
            </Alert>
            <FacebookPageList />
          </div>
        ) : (
          <div className="flex flex-col w-full items-center space-y-20">
            ...
            <Alert variant="outlined" severity="info">
              You may need to have a Facebook Page.
            </Alert>
          </div>
        )}
      </div>
...
export default ChannelFacebookForm;
