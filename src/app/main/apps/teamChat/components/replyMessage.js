  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <div
          className={clsx(
            'bubble flex flex-col relative justify-center max-w-640 shadow text-field-channel'
          )}
        >
          <div className="flex p-10 space-x-10">
            ...
            <div className="flex flex-col">
              <Typography className="text-12 font-medium">
        ...
        <Typography className="time text-11 mt-4" color="textSecondary">
          {replies[item.id][0].createdBy && `By: ${replies[item.id][0].createdBy.display} @ `}
