...
const RightSidebarContent = (props) => {
  ...
  useEffect(() => {
    console.log('customerSidebarOpen ', customerSidebarOpen);
    console.log('commentSidebarOpen ', commentSidebarOpen);
  }, [commentSidebarOpen, customerSidebarOpen]);
  ...
  return (
    ...
    >
      <div className="flex grow flex-col flex-auto justify-between">
        <Box
