...
const CommentSidebar = (props) => {
  ...
  return (
    // <div className={clsx('flex flex-col flex-auto h-full', isMobile ? 'w-[333px]' : 'w-[398px]')}>
    <div
      className={clsx(
    ...
    >
                    ...
                    >
                      ...
                      >
                        ...
                        <Typography className="contents text-xs" color="textSecondary">
                          {`${item.createdBy.display}: ${formatDistanceToNow(
      ...
      <div className="flex flex-auto min-h-0 w-full">
        <div className="flex flex-1 z-10 flex-col">
          <FuseScrollbars ref={chatScroll} className="flex flex-1 flex-col overflow-y-scroll">
            <div className="flex flex-col h-full">
              ...
              <div className="flex flex-col pt-16 pb-72">
