...
const ChatListItem = (props) => {
  ...
  return (
    <StyledListItem
      ...
      component={HashLink}
      to={`/apps/chat/${chat.id}/#${chat.lastMessage?.id}`}
      end
        ...
        <div className="flex flex-col grow">
          <div className="flex justify-between items-center">
            ...
            {chat.lastMessage && chat.lastMessage.createdAt && (
              <Typography className="whitespace-nowra font-medium text-12" color="text.secondary">
                {new Date().toDateString() === new Date(chat.lastMessage.createdAt).toDateString()
          ...
          <div className="flex justify-between">
            ...
            >
              ...
              {/* {chat.lastMessage.reaction && chat.lastMessage.reaction.emoji ? (
                <Twemoji svg text={chat.lastMessage.reaction.emoji} />
              ) : null} */}
            </Typography>
