  ...
  return (
    <Paper className="w-full rounded-xl shadow flex flex-col justify-between">
      ...
      <div className="text-center py-12">
        <Typography className="text-7xl sm:text-8xl font-semibold leading-none text-green-500 tracking-tighter">
          {props.data.data.count}
        </Typography>
        <Typography className="text-lg font-normal text-green-600">
